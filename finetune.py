...
class PrunningFineTuner_VGG16:
    ...
    def prune(self):
        ...
        print ("Number of prunning iterations to reduce 67th percentile filters: %d"%iterations)
        ...
        for _ in range(iterations):
            ...
            optimizer = optim.SGD(self.model.parameters(), lr=0.001, momentum=0.9, weight_decay=0.0005)
...
def get_args():
    ...
    parser.add_argument("--test_path", type = str, default = "val")
